...
class FunkinSoundTray extends FlxSoundTray
{
  ...
  public function new()
  {
    ...
    volumeUpSound = "assets/shared/images/soundtray/Volup.ogg";
    volumeDownSound = "assets/shared/images/soundtray/Voldown.ogg";
    volumeMaxSound = "assets/shared/images/soundtray/VolMAX.ogg";
  ...
  override public function update(MS:Float):Void
  {
    ...
    var shouldHide = (FlxG.sound.muted == false && FlxG.sound.volume > -1);
