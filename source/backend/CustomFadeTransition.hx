...
class CustomFadeTransition extends MusicBeatSubstate {
	...
	override function create()
	{
		...
		transGradient = FlxGradient.createGradientFlxSprite(50, height, (isTransIn ? [0x0, FlxColor.BLACK] : [FlxColor.BLACK, 0x0]));
		...
		transBlack = new FlxSprite().makeGraphic(50, 1, FlxColor.BLACK);
