...
class Paths
{
	...
	inline static public function inst(song:String, ?postFix:String = '', ?modsAllowed:Bool = true):Sound
		return returnSound('${formatToSongPath(song)}/Inst${postFix}', 'songs', modsAllowed);
