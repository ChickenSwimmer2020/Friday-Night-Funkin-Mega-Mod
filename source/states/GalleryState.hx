...
class GalleryMenuState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		descriptionText = new FlxText(50, 0, FlxG.width - 100, imageDescriptions[currentIndex]);
		...
		titleText = new FlxText(50, 0, FlxG.width - 100, imageTitle[currentIndex]);
