...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['ChickenSwimmer2020',  'CS20-smal',				'Director\n\"The furry that made his dream come to life\"',		'LINK',					'#00FF00'],
			['Coders'],
			['ChickenSwimmer2020',  'CS20-smal',				'Main Coder (HAXE)\n\"The furry that Coded this mess of spaghetti code\"',	'LINK',					'#00FF00'],
			[''],
			['Testers/Debuggers'],
			...
			[''],
			['Charters'],
			['ChickenSwimmer2020',  'CS20-smal',				'Main Charter\n\"The furry that Charted this mess of spaghetti code\"',	'LINK',					'#00FF00'],
			[''],
			['composers'],
			['ChickenSwimmer2020',  'CS20-smal',				'Composed the menu music',	'LINK',					'#00FF00'],
			['ChickenSwimmer2020',  'CS20-smal',				'Composer of digital',	'LINK',					'#00FF00'],
			[''],
			['Animators'],
			['ChickenSwimmer2020',  'CS20-smal',				'Main Animator\n\"The furry that Animated this mess of spaghetti code\"',	'LINK',					'#00FF00'],
			[''],
			['Psych Engine Team'],
		...
		for (i in 0...creditsStuff.length)
		{
			...
			if(isSelectable) {
				...
				if(str.endsWith('-smal')) icon.scale.x = 0.2;
				if(str.endsWith('-smal')) icon.scale.y = 0.2; 
				if(str.endsWith('-smal')) icon.yAdd = -325;
				icon.xAdd = optionText.width + 10;
				if(str.endsWith('-smal')) icon.xAdd = optionText.width - 200;
